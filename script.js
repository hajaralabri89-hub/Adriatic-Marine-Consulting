...
(function () {
  ...
  const animatedEls = document.querySelectorAll(
    '.service-card, .training-card, .case-card, .team-card, .founder-card, .onboard-point, .number-box'
  );
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      /*
       * To send via Formspree, replace the setTimeout above with:
       *
       ...
       *     form.reset();
       *   } else {
       *     showFeedback('Something went wrong. Please email us directly.', 'error');
       *   }
       * })
       * .catch(function () {
       *   showFeedback('Something went wrong. Please email us directly.', 'error');
